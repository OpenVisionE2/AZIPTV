...
class SetChNo(Screen):
    skin = '\n\t\t<screen position="0,0" size="120,60" title="AzIPTV v.1.0" flags="wfNoBorder" >\n\t\t<widget name="infoM0" position="10,10" zPosition="2" size="50,40" font="Regular;40" foregroundColor="#ffffff" transparent="0" horizontalAlignment="center" verticalAlignment="center" />\n\t\t<widget name="infoM1" position="60,10" zPosition="2" size="50,40" font="Regular;40" foregroundColor="#ffffff" transparent="0" horizontalAlignment="center" verticalAlignment="center" />\n\t\t<widget name="infoM2" position="110,10" zPosition="2" size="50,40" font="Regular;40" foregroundColor="#ffffff" transparent="0" horizontalAlignment="center" verticalAlignment="center" />\n\t\t</screen>'
